...
def get_activity_time_dashboard(activity_id_str):
    url_test = r'https://dashboard.waka.media/activity-dashboard/dashboard/key/activity/list?pageIndex=1&pageSize=20&activityId={}&status='.format(activity_id_str)
