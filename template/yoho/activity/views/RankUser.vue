...
import RankTemplate from '../../components/Base/RankTemplate.vue'
import { useRankPage } from './SuperRank/useRankPage'

// 使用通用榜单页面逻辑
const { dayTotal, selDate, tempConfig, activityId } = useRankPage('RankUser')
</script>
