...
// import { useAppStore, yohoUi, domain } from "../store";
...
// 常量配置（不可修改）
export const yohoUi = (window as any).hostConfig.oss + '/activity/yoho-ui'
export const domain = projectType == 2 ? 'chatchill' : (window as any).hostConfig.domain
export const oss = (window as any).hostConfig.oss
export const cdn =
  ENV == 'build' ? (window as any).hostConfig.cdn : (window as any).hostConfig.cdnTest
